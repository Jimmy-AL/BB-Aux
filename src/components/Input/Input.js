            ...
            <div className='container flex relative mb-2'>
                ...
                {hint
                    ?<div class="group relative inline-block">
                        ...
                        <QuestionMarkCircleIcon className="h-5 w-5 relative inset-y-1 -left-1 text-blue-950"/>
                    </div>
                    //<QuestionMarkCircleIcon className="h-5 w-5 absolute bottom-0 right-0 text-blue-950"/>
                    : <></>}
